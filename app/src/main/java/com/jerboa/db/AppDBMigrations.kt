...
val MIGRATION_26_27 = object : Migration(26, 27) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL(
            "ALTER TABLE AppSettings ADD COLUMN top_comment_only INTEGER NOT NULL DEFAULT 0",
        )
    }
}

val MIGRATION_27_26 = object : Migration(27, 26) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL(
            "ALTER TABLE AppSettings DROP COLUMN top_comment_only",
        )
    }
}
